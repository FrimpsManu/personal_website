...
import { sendEmail, trackFormSubmission, ContactFormData } from '../services/emailService';
...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        trackFormSubmission(formData as ContactFormData, true);
        setIsSubmitted(true);
        ...
        trackFormSubmission(formData as ContactFormData, false);
