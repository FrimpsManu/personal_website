...
const InteractiveTimeline: React.FC = () => {
  ...
  const timelineEvents: TimelineEvent[] = [
    ...
    },
    {
      ...
      type: 'achievement',
      description: 'Co-organized the Notion x Grambling hackathon with 60+ participants by leading a 10+ member team, securing $3,000+ in sponsorship, and mentoring participants to successfully launch 5 minimum viable products (MVPs).',
      highlights: [
        'Led a 10+ member organizing team for successful hackathon execution',
        'Secured $3,000+ in sponsorship funding for the event',
        'Mentored 60+ participants across multiple teams',
        'Facilitated the successful launch of 5 minimum viable products (MVPs)',
        'Coordinated logistics, workshops, and judging for the entire event'
      ],
    ...
    },
    {
      ...
      location: 'Grambling, LA',
      type: 'achievement',
      description: 'First place for building a real-time language translation app achieving 98% translation accuracy across 3 languages.',
      highlights: [
        'Achieved 98% translation accuracy across 3 languages using OpenAI API',
        'Built full-stack solution with Flask, JavaScript, and Speech API for TTS interaction',
        'Created intuitive dashboard for portfolio management'
      ],
    ...
    },
    {
      ...
      highlights: [
        'Provided technical support for 50+ campus devices',
        'Improved setup speed by 90% through streamlined deployments',
        'Reduced issue resolution time by 85%'
      ],
    ...
    },
    {
      ...
      highlights: [
        'Magna Cum Laude with 3.96/4 Cummulative GPA',
        '4x President List',
        'Led team project developing campus event management system',
        'Completed senior capstone project on "Coming Soon"'
      ],
    ...
    },
    {
      ...
      highlights: [
        'Assessed 10+ public companies by conducting in-depth equity research and building sector-specific DCF valuation models',
        'Led to high-confidence investment theses used in mentor-led discussions'
      ],
          ...
          <div className="space-y-12">
            {filteredEvents.map((event, index) => (
              ...
              >
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-6 md:left-1/2 transform md:-translate-x-1/2 w-6 h-6 rounded-full border-4 border-white dark:border-gray-800 z-10 transition-colors duration-300">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`px-2 py-1 rounded text-xs font-medium ${
                              event.type === 'work' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
                              event.type === 'education' ? 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400' :
                              event.type === 'achievement' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400' :
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">{selectedEvent.description}</p>
