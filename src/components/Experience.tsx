...
const Experience: React.FC = () => {
  const experiences = [
    ...
    },
    {
      ...
      location: 'Austin, TX',
      period: '2020 - 2022',
      description: 'Developed MVP from concept to production launch. Built responsive web applications and RESTful APIs for e-commerce platform.',
      achievements: [
    ...
    },
    {
      ...
      location: 'Remote',
      period: '2019 - 2020',
      description: 'Created responsive websites and web applications for diverse clients. Collaborated with designers to implement pixel-perfect UI/UX.',
      achievements: [
                    ...
                    <div className="ml-16 md:ml-0 bg-gray-50 dark:bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-200 dark:border-gray-700 hover:border-blue-500/30 transition-all duration-300 hover:transform hover:scale-[1.02]">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                        <div>
                          ...
                          <h4 className="text-blue-600 dark:text-blue-400 font-semibold mb-2 transition-colors duration-300">{exp.company}</h4>
                        </div>
                      ...
                      <div className="mb-6">
                        <h5 className="text-gray-900 dark:text-white font-semibold mb-3 transition-colors duration-300">Key Achievements:</h5>
                        <ul className="space-y-2">
                          {exp.achievements.map((achievement, i) => (
                            <li key={i} className="text-gray-600 dark:text-gray-300 flex items-start gap-2 transition-colors duration-300">
